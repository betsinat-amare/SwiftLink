...
useEffect(() => {
  ...
  const fetchFlights = async () => {
    try {
      const res = await fetch('https://herbackend-4.onrender.com/api/flights/get');
  ...
  try {
    const res = await fetch('https://herbackend-4.onrender.com/api/flights/shipments', {
      headers: {
...
const fetchUserPoints = async () => {
  try {
    const res = await fetch("https://herbackend-4.onrender.com/api/points/me", {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  const handleAddFlight = async () => {
    ...
    try {
      const res = await fetch('https://herbackend-4.onrender.com/api/flights/add', {
        method: 'POST',
        headers: {
